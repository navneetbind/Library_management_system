...
const teamMembers = [
  {
    name: 'Navneet Kumar Bind',
    role: 'Full Stack Developer',
    image: 'https://avatars.githubusercontent.com/u/134391729?s=400&u=6d939e7b6bfb9bd0be4bb9c56af8ed0d699a773f&v=4', 
    linkedin: 'https://www.linkedin.com/in/navneetbind/',
    github: 'https://github.com/navneetbind',
  },
];
...
const AboutUs = () => {
  return (
    <div className="container mx-auto px-4 py-8 mt-24">
      ...
      <h2 className="text-2xl font-semibold mb-4 text-center">Me</h2>
